...
class Trainer:
    ...
    def __init__(self,
        ...
        self.config = Config(
            ...
            input_types=input_types, output_types=output_types, prefix_types=prefix_types, 
            instruction_types=instruction_types, model=model,
    ...
    def train(self, model_dir, epoch_save: None or int = 1, interval: int = 25, epoch_partial: int = None):
        ...
        for (i, o, p, instruct), cache_path in self.data_cache_paths:
            ...
            encode_list += self.model.text_to_encode(text_input, text_output, prefix_type=instruct_output, cache_path=cache_path)
