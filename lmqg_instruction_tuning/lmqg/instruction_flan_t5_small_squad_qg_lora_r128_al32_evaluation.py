...
def main():
    ...
    args = easydict.EasyDict({"checkpoint_dir": "tmp_instruction_flan_t5_small_squad_qg_lora_r128_al32", 
                              
                              "project": "lmqg_qg_squad",
                              
                              "entity": "minseok0809",
                              
                              "name": "instruction_flan_t5_small_squad_qg_lora_r128_al32",
                              
                              "dataset_path": "qg_squad", 
            ...
            for n, checkpoint_dir in enumerate(checkpoints):
                for i in range(1, self.epoch+1):
                    if i % self.epoch_partial == 0:
                        ...
                        metrics = [[checkpoint_dir_model, metric['test']['Bleu_4']]]
