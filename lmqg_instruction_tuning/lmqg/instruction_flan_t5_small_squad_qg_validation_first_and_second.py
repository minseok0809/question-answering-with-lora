...
from .validation import Trainer, to_list
...
def main():
    ...
    args = easydict.EasyDict({"checkpoint_dir": "tmp_instruction_flan_t5_small_squad_qg_first_and_second", 
                              
                              "project": "lmqg_qg_squad",
                              
                              "entity": "minseok0809",
                              
                              "name": "instruction_flan_t5_small_squad_qg_first_and_second",
                              
                              "dataset_path": "data_first_and_second", 
                              ...
                              "pretrained_model_path": "tmp_instruction_flan_t5_small_squad_qg_first_and_second/model_kgiyxs/epoch_",
    ...
    class GridSearcher:
        ...
        def get_evaluator(self, overwrite: bool):
            ...
            def get_evaluation(_checkpoint_dir_model, _pretrained_model_path):
                return evaluate(
        ...
        def run(self, interval: int = 25, overwrite: bool = False):
            ...
            trainer = Trainer(
                checkpoint_dir=checkpoint_dir, model_dir=model_dir, pretrained_model_path=self.pretrained_model_path,  disable_log=True, use_auth_token=self.use_auth_token,
