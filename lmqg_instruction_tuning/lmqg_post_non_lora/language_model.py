...
def load_language_model(model_name,
    ...
    elif os.path.isfile(pretrained_model_path + '/pytorch_model.bin') == True and os.path.isfile(pretrained_model_path + '/traning start.txt') == False:
    ...
    def generate_a(self,
        ...
        if self.answer_model_type == 'multitask':
            answer = self.generate_prediction(
                ...
                prefix_type=prefix_type if self.add_prefix else None,
                cache_path=cache_path,
                num_beams=num_beams,
                batch_size=batch_size
            )
            ...
            answer = self.generate_prediction(
                flat_inputs,  # list_input,
                highlights=flat_sentences,  # highlights=list_sentence,
                prefix_type=prefix_type if self.add_prefix_ae else None, #'ae'
                cache_path=cache_path,
                num_beams=num_beams,
                batch_size=batch_size,
