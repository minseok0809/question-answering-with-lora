...
def main():
    ...
    args = easydict.EasyDict({"checkpoint_dir": "tmp_ckpt_flan_t5_small_squad_qg_lora_r16_al32", 
                              
                              "project": "lmqg_qg_squad",
                              
                              "entity": "minseok0809",
                              
                              "name": "flan_t5_small_squad_qg_lora_r16_al32",
    ...
    class GridSearcher:
        ...
        def __init__(self, checkpoint_dir: str = args.checkpoint_dir,
                    ...
                    model_adapter: bool = args.model_adapter, 
                    lora_rank: int = args.lora_rank, lora_alpha: int = args.lora_alpha,
                    fp16: bool = args.fp16,
                    ...
                    batch: int = args.batch, batch_eval: int = 32, n_beams_eval: int = 4, 
            ...
            self.static_config = {
                ...
                'lora_rank': lora_rank, 'lora_alpha': lora_alpha, 'fp16': fp16, 'batch': batch, 'epoch': epoch,
