...
def main():
    ...
    args = easydict.EasyDict({"checkpoint_dir": "tmp_ckpt_flan_t5_xl_squad_qg_lora_r64_al32", 
                              
                              "project": "lmqg_qg_squad",
                              
                              "entity": "minseok0809",
                              
                              "name": "flan_t5_xl_squad_qg_lora_r64_al32",
    ...
    class GridSearcher:
        ...
        def __init__(self, checkpoint_dir: str = args.checkpoint_dir,
                    ...
                    normalize: bool = True,  
                    use_auth_token: bool = False, torch_dtype=None, device_map: str = None,
        ...
        def run(self, interval: int = 25, overwrite: bool = False):
            ...
            if not os.path.exists(pj(checkpoint_dir, f'epoch_{self.epoch}')):
                trainer = Trainer(
                    checkpoint_dir=checkpoint_dir, model_dir=model_dir, disable_log=True, 
                    use_auth_token=self.use_auth_token,
